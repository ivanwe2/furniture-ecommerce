export const bg = {
  ...
  home: { featured: 'Акценти', categoriesTitle: 'Категории',
    ...
    heroLead: 'Официален представител на водещи марки. Доказано качество, наложен платеж и бърза консултация.',
    heroCta: 'Разгледай каталога',
    heroArtLabel: 'ART.01 · ПАНТА Ø35',
    statYears: '20+ години опит',
    statCod: 'Наложен платеж',
    ...
    trust2Title: 'Плащане при доставка',
    trust2Body: 'Наложен платеж - плащате при получаване, без риск.',
