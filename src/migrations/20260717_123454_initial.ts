...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_items_unit" AS ENUM('бр.', 'м', 'компл.', 'чифт');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('нова', 'потвърдена', 'изпратена', 'доставена', 'отказана');
  CREATE TYPE "public"."enum_orders_delivery_method" AS ENUM('адрес', 'офис на Еконт', 'офис на Спиди');
  ...
  CREATE TABLE "products_short_spec" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "products_items" (
  	...
  	"unit" "enum_products_items_unit" DEFAULT 'бр.',
  	"length_mm" numeric,
  	"color" varchar,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"company_name" varchar DEFAULT 'Настех ООД' NOT NULL,
  	"eik" varchar,
  	"address_line" varchar DEFAULT 'ул. „Жан Жорес“ 9' NOT NULL,
  	"city" varchar DEFAULT 'Пловдив',
  	"email" varchar DEFAULT 'nastehsales@gmail.com' NOT NULL,
  	"working_hours" varchar DEFAULT 'Пон-Пет: 08:30-17:30
  Съб: 09:00-14:00',
  	"hero_title" varchar,
  ...
  ALTER TABLE "products_short_spec" ADD CONSTRAINT "products_short_spec_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "products_short_spec_order_idx" ON "products_short_spec" USING btree ("_order");
  CREATE INDEX "products_short_spec_parent_id_idx" ON "products_short_spec" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "products_short_spec" CASCADE;
  ...
  DROP TYPE "public"."enum_products_items_unit";
